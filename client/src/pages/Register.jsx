          ...
          {role === 'student' && (
            <>
              <div className="register-oauth">
                <a href={`${API_BASE_URL}/auth/google`} className="register-oauth-btn register-oauth-google">
                ...
                <a href={`${API_BASE_URL}/auth/github`} className="register-oauth-btn register-oauth-github">
